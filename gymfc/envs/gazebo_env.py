...
class GazeboEnv(gym.Env):
    ...
    def _start_sim(self):
        ...
        # cross platform
        os.environ["GAZEBO_RESOURCE_PATH"] = "/usr/local/share/gazebo-10" + os.pathsep + gz_resource
        os.environ["GAZEBO_PLUGIN_PATH"] = "/usr/local/lib/gazebo-10/plugins" + os.pathsep + gz_plugins
        os.environ["GAZEBO_MODEL_PATH"] = "/usr/local/share/gazebo-10/models" + os.pathsep + gz_models

        os.environ["LD_LIBRARY_PATH"] = "/usr/local/lib/gazebo-10/plugins" + os.pathsep + ld_library_path
